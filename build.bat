...
set "ALLOWED_EXT=.bzn .hg2 .lgt .lua .mat .trn .otf .wav .dds .png .material .geo .mesh .skeleton .sdf .vdf .odf .inf .des .ini .sta .cfg .wtx"
...
REM BZ1 Only (LGT still generated by BZ98R so added to stop generation)
REM .hgt .lgt .map
